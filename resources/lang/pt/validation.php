...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'e_sex_emplo' => [
            'required' => 'É obrigatória a indicação de um valor para o campo sexo'
        ],
        'c_area_emplo' => [
            'required' => 'É obrigatória a indicação de um valor para o campo area de actividade',
            'max'      => 'O campo area de actividade não deverá conter mais de :max caracteres.'
        ],
        'd_datebirth_emplo' => [
            'required' => 'É obrigatória a indicação de um valor para o campo data de nascimento'
        ],
        'c_email_emplo' => [
            'required' => 'É obrigatória a indicação de um valor para o campo correio eletrónico',
            'email'    => 'O campo email não contém um endereço de correio eletrónico válido.'
        ],
        'i_phone_emplo' => [
            'required' => 'É obrigatória a indicação de um valor para o campo telefone',
            'numeric'  => 'O campo telefone deverá conter um valor numérico.'
        ]
    ],
